	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { style: { margin: '25px auto', paddingTop: 50, textAlign: 'center' } },
	        showBox && React.createElement(
	          'h2',
	          null,
	          'Counter: ',
	          counter
	  ...
	  incCounterAndToggleBox: function incCounterAndToggleBox() {
	    ...
	    */
	      ...
	      */
					...
					renderTipsy: function renderTipsy() {
						...
						return _react2.default.createElement('div', { className: className, role: 'tooltip', style: { display: '' } }, _react2.default.createElement('div', { className: 'react-tipsy-arrow' }), _react2.default.createElement('div', { className: 'react-tipsy-inner' }, this.props.content));
					},
					show: function show() {
						// render tooltip
